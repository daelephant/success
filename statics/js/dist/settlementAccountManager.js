$(function() {
	...
	function c() {
		...
		}), k.datepicker("setDate", new Date), k.blur(function(a) {
			var b = k.val();
			"" == b && k.datepicker("setDate", new Date)
	...
	function e(a, b) {
		...
		h.id ? params = {
			...
			amount: k,
			date: m
		}, Public.ajaxPost("../basedata/settAcct.do?action=" + ("add" == a ? "add" : "update"), params, function(b) {
			if (200 == b.status) {
