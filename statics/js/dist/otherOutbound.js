var curRow, curCol, curArrears, loading, urlParam = Public.urlParam(),
	...
	THISPAGE = {
		init: function(a) {
			this.mod_PageConfig = Public.mod_PageConfig.init("otherOutbound"), SYSTEM.isAdmin !== !1 || SYSTEM.rights.AMOUNT_COSTAMOUNT || (hiddenAmount = !0), this.loadGrid(a), this.initDom(a), this.initCombo(), this.addEvent(), $.cookie("BarCodeInsert") && THISPAGE.$_barCodeInsert.addClass("active"), this.goodsEdittypeInit()
		},
		initDom: function(a) {
			...
			this.customerCombo = Business.billCustomerCombo($("#customer"), {
				...
				data: "../scm/invOi.do?action=queryTransType&type=out",
				ajaxOptions: {
			...
			var c = "",
				d = "",
				e = "";
			if (billRequiredCheck && (c = '<a class="ui-btn" id="audit">审核</a>', d = '<a class="ui-btn" id="reAudit">反审核</a>'), this.btn_audit = c, this.btn_reaudit = d, this.btn_tempSave = e, this.btn_add = '<a id="savaAndAdd" class="ui-btn ui-btn-sp mrb">保存并新增</a><a id="save" class="ui-btn">保存</a>' + e, this.btn_edit = '<a id="add" class="ui-btn ui-btn-sp mrb">新增</a><a href="../scm/invOi.do?action=toOoPdf&billType=OO" target="_blank" id="print" class="ui-btn mrb">打印</a><a id="edit" class="ui-btn">保存</a>', this.btn_view = '<a id="add" class="ui-btn ui-btn-sp mrb">新增</a><a href="../scm/invOi.do?action=toOoPdf&billType=OO" target="_blank" id="print" class="ui-btn mrb">打印</a>', this.btn_p_n = '<a class="ui-btn-prev mrb" id="prev" title="上一张"><b></b></a><a class="ui-btn-next" id="next" title="下一张"><b></b></a>', a.id > 0) {
		...
		addEvent: function() {
			...
			this.customerCombo.input.enterKey(), this.$_date.bind("keydown", function(a) {
				...
				d && ("edit" === originalData.stata && (d.id = originalData.id, d.stata = "edit"), c.addClass("ui-btn-dis"), Public.ajaxPost("../scm/invOi.do?action=addOo&type=out", {
				...
				if (b.preventDefault(), Business.verifyRight("OO_UPDATE")) {
					...
					c && Public.ajaxPost("../scm/invOi.do?action=updateOo&type=out", {
				...
				if (b.preventDefault(), Business.verifyRight("OO_CHECK")) {
					var c = THISPAGE.getPostData();
					c && Public.ajaxPost("../scm/invOi.do?action=checkInvOo", {
						postData: JSON.stringify(c)
					}, function(b) {
				...
				if (b.preventDefault(), Business.verifyRight("OO_UNCHECK")) {
					var c = $(this);
					c.ajaxPost("../scm/invOi.do?action=rsBatchCheckInvOo", {
						id: originalData.id
					}, function(b) {
				...
				var d = THISPAGE.getPostData();
				d && (c.addClass("ui-btn-dis"), Public.ajaxPost("../scm/invOi.do?action=addNewOo&type=out", {
					postData: JSON.stringify(d)
				}, function(b) {
				...
				return b.preventDefault(), $(this).hasClass("ui-btn-prev-dis") ? (parent.Public.tips({
					type: 2,
					content: "已经没有上一张了！"
				}), !1) : (a.idPostion = a.idPostion - 1, 0 === a.idPostion && $(this).addClass("ui-btn-prev-dis"), loading = $.dialog.tips("数据加载中...", 1e3, "loading.gif", !0), Public.ajaxGet("../scm/invOi.do?action=updateOut&type=out", {
				...
				return b.preventDefault(), $(this).hasClass("ui-btn-next-dis") ? (parent.Public.tips({
					type: 2,
					content: "已经没有下一张了！"
				}), !1) : (a.idPostion = a.idPostion + 1, a.idLength === a.idPostion + 1 && $(this).addClass("ui-btn-next-dis"), loading = $.dialog.tips("数据加载中...", 1e3, "loading.gif", !0), Public.ajaxGet("../scm/invOi.do?action=updateOut&type=out", {
					id: a.salesListIds[a.idPostion]
				}, function(a) {
...
$(function() {
	if (urlParam.id) hasLoaded || Public.ajaxGet("../scm/invOi.do?action=updateOut&type=out", {
		id: urlParam.id
	}, function(a) {
