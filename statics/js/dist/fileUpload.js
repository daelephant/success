$(function() {
	var a = {
		...
		initDom: function() {
			var b = a.api.data || {};
			b.id && Public.ajaxPost("../basedata/inventory.do?action=getImagesById", {
				id: b.id
			}, function(b) {
		...
		postData: function() {
			...
			if (b.id) {
				...
				Public.ajaxPost("../basedata/inventory.do?action=addImagesToInv", {
		...
		initUpload: function() {
			...
			b.$upfile.fileupload({
				url: "../basedata/inventory.do?action=uploadImages",
				maxFileSize: 5e6,
				sequentialUploads: !0,
