define(["jquery", "print"], function(a) {
	function b() {
		...
		i("#filter-submit").on("click", function(b) {
			...
			a.preventDefault(), i("#filter-fromDate").val(k.beginDate), i("#filter-toDate").val(k.endDate), i("#filter-supplier input").val(""), i("#filter-goods input").val(""), i("#filter-storage input").val(""), k.customerNo = "", k.goodsNo = "", k.storageNo = "", chkboxes.chkNot()
		})
	}
	function c() {
	...
	var i = a("jquery"),
		...
		l = "../report/puDetail.do?action=invExporter",
		m = "../report/puDetail.do?action=inv";
	a("print");
	var n = Public.mod_PageConfig.init("puSummaryNew");
	b(), c(), d();
	var o;
