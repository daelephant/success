...
var handle = {
	...
	del: function(a) {
		$.dialog.confirm("删除的仓库将不能恢复，请确认是否删除？", function() {
			Public.ajaxPost("../basedata/invlocation.do?action=delete", {
				locationId: a
			}, function(b) {
	...
	setStatus: function(a, b) {
		a && Public.ajaxPost("../basedata/invlocation.do?action=disable", {
			locationId: a,
			disable: Number(b)
		}, function(c) {
	...
	setStatuses: function(a, b) {
		a && 0 != a.length && Public.ajaxPost("../basedata/invlocation.do?action=disable", {
