...
class Log extends CI_Controller {
	...
	public function index() {
		switch ($this->action) {
			case 'list':
			    $this->logList();break;	
			case 'initloglist':
			    $this->initloglist();break;
			case 'queryAllUser':
			    $this->queryAllUser();break;
			case 'getAssistType':
			    $this->getAssistType();break;
			case 'queryAllOperateType':
			    $this->queryAllOperateType();break;
			default:  
			    str_alert(-1,'非法请求');
		}
	}
    ...
    //操作类型
	private function queryAllOperateType(){
