...
<table width="1440px" class="list">
  		...
  		<table width="1000px" class="list" border="1">
				 ...
				 foreach($list as $arr=>$row){
				      $sum1  += $arrears1 = $row['type']==-10 ? $row['arrears'] : 0; 
					  $sum2  += $arrears2 = $row['type']==10 ? $row['arrears'] : 0; 
				 ?>
  				<tr>
  			       <td><?php echo $i?></td>
  			       ...
  			       <td class="R"><?php echo str_money($arrears1,2)?></td>
  			       <td class="R"><?php echo str_money($arrears2,2)?></td>
  				</tr>
  			    <?php 
				 $i++;
				 }
