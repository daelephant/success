...
<table width="1440px" class="list">
  		...
  		<table width="1440px" class="list" border="1">
				...
				<tr class="link" data-id="0" data-type="BAL">
				   ...
				   <td align="center"><?php echo str_money($amount,2)?> </td>
				   <?php 
				   $i = 2;
				   foreach($storage as $arr1=>$row1){
				       $qty['qty'.$i]  += $row['qty'.$i];
				   ?>
				   <td align="center" colspan="2"><?php echo str_money($row['qty'.$i],$this->systems['qtyPlaces'])?></td>
			   ...
			   <tr class="link" data-id="0" data-type="BAL">
				   ...
				   $i = 2;
				   foreach($storage as $arr1=>$row1){?>
				   <td align="center" colspan="2"><?php echo str_money($qty['qty'.$i],$this->systems['qtyPlaces'])?></td>
