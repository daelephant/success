...
<table width="1440px" class="list">
  			<tr><td class='H' colspan="<?php echo $showDetail == "true" ? 14 : 8?>" align="center"><h3>接收单位对账单<h3></td></tr>
  		...
  		<table width="1440px" class="list" border="1">
  			...
  			<tbody>
  				<tr class="link" data-id="0" data-type="BAL">
				   ...
				   <td class="R"></td>
  			       <td class="R"></td>
  			       <td class="R"><?php echo $list1['arrears']?></td>
  				</tr>
				 ...
				 ?>
  				<tr>
				   ...
				   <?php  }?>
  			       ...
  			       <td class="R"><?php echo str_money($list1['arrears'] + $sum1,2)?></td>
  				</tr>
				...
				<?php  }?>   
  				...
  				<td class="R B"><?php echo str_money($list1['arrears'] + $sum1,2)?></td>
  				</tr> 
  			</tbody>
  		</table>