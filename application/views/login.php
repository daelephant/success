...
<html>
    <head>
        ...
        <link href="<?php echo base_url()?>statics/login/<?php echo sys_skin()?>/Css/common.css?229" rel="stylesheet" />
        <link href="<?php echo base_url()?>statics/login/<?php echo sys_skin()?>/Css/global.css?339" rel="stylesheet" />
        ...
        <script src="<?php echo base_url()?>statics/login/<?php echo sys_skin()?>/Scripts/minijs/jquery-1.7.1.js?33"></script>
        <script src="<?php echo base_url()?>statics/login/<?php echo sys_skin()?>/Scripts/minijs/common.js?33"></script>
        <script src="<?php echo base_url()?>statics/login/<?php echo sys_skin()?>/Scripts/minijs/minicheck.js?33"></script>
...
<div class="loading">
	<img src="<?php echo base_url()?>statics/login/<?php echo sys_skin()?>/Images/loading.gif?33" style="position:absolute;top:50%;left:50%;margin:-82px 0 0 -135px;" alt="请稍后...">
</div>
