...
<style>
.mod-form-rows .label-wrap {width: 100px;}
.row-item{position: relative;}
.mod-form-rows .tips{border: #ccc dotted 1px;
    padding: 3px;
  ...
  <div class="settings-ctn" id="printSettings">
      <div class="item">
        ...
        <ul class="mod-form-rows" id="pdfSettings">
          ...
          <li class="row-item">
              <div class="label-wrap">
                <label for="pdfEntrysPerNote">每张打印行数:</label>
              </div>
              <div class="ctn-wrap">
...
<script>
 (function($){
    ...
    function pdfPrint(){
      ...
      pdfData.entrysPerNote = $('#pdfEntrysPerNote').val(); //每张打印行数
      $.cookie('pdfMarginLeft', pdfData.marginLeft, {expires: 365});
      $.cookie('pdfEntrysPerNote', pdfData.entrysPerNote, {expires: 365});
