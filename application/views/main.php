...
<div id="hd" class="cf">
  ...
  <div class="fr storages-search"><label style="display:none;"><a class="b" id="invWarning">库存预警</a></label><label for="">库存查询</label><span class="ui-search"><input type="text" id="goodsAuto" class="ui-input" /></span><span id="stockSearch"></span></div>
</div>
<script>
  ...
  <div class="col-main">
    <div class="main-wrap cf">
      ...
      <!-- 
       ...
       -->
		<table style="display:none;" width="100%" border="0" cellspacing="0" cellpadding="20">
		  <tr>
		    <td style="display:none;"><a class="ta t1" tabid="report-initialBalance" data-right="InvBalanceReport_QUERY" tabTxt="商品库存余额" parentOpen="true" rel="pageTab" href="<?php echo site_url('report/goods_balance')?>">商品库存余额</a></td>
		    ...
		    <td><a class="ta t4" tabid="report-salesSummary" data-right="SAREPORTINV_QUERY" tabTxt="出库汇总表（按商品）" parentOpen="true" rel="pageTab" href="<?php echo site_url('report/sales_summary')?>">出库汇总表</a></td>
      ...
      <ul class="quick-links">
        ...
        <li class="sales-sales">
        	<a tabid="sales-sales" data-right="SA_ADD" tabTxt="出库单" parentOpen="true" rel="pageTab" href="<?php echo site_url('scm/invSa')?>?action=initSale"><span></span>出库</a>
        </li>
        <li class="storage-transfers">
        	<a tabid="storage-transfers" data-right="TF_ADD" tabTxt="采购库出入详情" parentOpen="true" rel="pageTab" href="<?php echo site_url('report/pu_detail_new')?>"><span></span>采购库出入详情</a>
        </li>
      ...
      <!--   <li class="storage-otherWarehouse">
        ...
        <li class="added-service">
        	<a tabid="setting-addedServiceList" tabTxt="" parentOpen="true" rel="pageTab" href="<?php echo site_url('settings/addedServiceList')?>"><span></span>增值服务</a>
			<a href="#" id="feedback"><span></span></a>
        </li>
        <li class="feedback">
        	<a href="#" id="feedback"><span></span></a>
        </li> -->
...
<script id="profile" type="text/html">
		<table style="display:none;" width="100%" border="0" cellspacing="0" cellpadding="20">
		  <tr>
		    ...
		    <td><a class="tad t4" tabid="report-salesSummary" data-right="SAREPORTINV_QUERY" tabTxt="出库汇总表（按商品）" parentOpen="true" rel="pageTab" href="<?php echo site_url('report/sales_summary')?>"><span>出库收入(本月):<b><#= items[3].total1 #></b></span><span>商品毛利(本月):<b><#= items[3].total2 #></b></span></a></td>
