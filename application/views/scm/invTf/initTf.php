  ...
  <div class="bills cf">
    <div class="con-header">
      <dl class="cf">
        <dd>
          <label>单据日期：</label>
          <input type="text" id="date" class="ui-input ui-datepicker-input" value="2015-11-17">
        </dd>
...
<script src="<?php echo base_url()?>statics/js/dist/transfers.js?ver=20151110"></script>
</body>
</html>
