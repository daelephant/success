...
?>
		...
		<table width="800" align="center">
			<tr height="15" align="left">
				<td width="150" style="font-family:'宋体'; font-size:14px;">单据日期：<?php echo $row['billDate']?> </td>
				<td width="100" style="font-family:'宋体'; font-size:14px;"></td>
				<td width="100" style="font-family:'宋体'; font-size:14px;"></td>
				<td width="150" style="font-family:'宋体'; font-size:14px;"></td>
				<td width="250" style="font-family:'宋体'; font-size:14px;">单据编号：<?php echo $row['billNo']?></td>
		...
		<table width="800" border="1" cellpadding="2" cellspacing="1" align="center" style="border-collapse:collapse;border:solid #000000;border-width:1px 0 0 1px;">   
			...
			<tr style="border:solid #000000;border-width:0 1px 1px 0;padding:2px;height:12px;font-family:'宋体'; font-size:12px;">
				<td  align="center"><?php echo $arr1+1?></td>
				<td width="280" ><?php echo $row1['invNumber'].' '.$row1['invName'].' '.$row1['invSpec'];?></td>
				<td width="60" align="center"><?php echo $row1['mainUnit']?></td>
				<td width="60"  align="right"><?php echo str_money(abs($row1['qty']),$system['qtyPlaces'])?></td>
				<td width="130" align="left"><?php echo $row1['outLocationName']?></td>
				<td width="130" align="left"><?php echo $row1['inLocationName']?></td>
			</tr>
			<?php 
			$s = $arr1+1;
			}
		...
		<table  width="800" align="center">
		    <tr height="15" align="left">
				<td align="left" width="780" style="font-family:'宋体'; font-size:14px;height:15px;">备注： <?php echo $row['description']?></td>
		...
		<table  width="800" align="center">
			<tr height="15" align="left">
				<td align="left" width="250" style="font-family:'宋体'; font-size:14px;">制单人：<?php echo $row['userName']?> </td>
