...
?>
		<table  width="800"  align="center">
			...
			<tr height="15px">
				<td align="center" style="font-family:'宋体'; font-size:18px; font-weight:normal;height:25px;"><?php echo $row['transType']==150501 ? '采购订单' :'采购退货订单'?></td>
			</tr>
		</table>	
		...
		<table width="800" border="1" cellpadding="2" cellspacing="1" align="center" style="border-collapse:collapse;border:solid #000000;border-width:1px 0 0 1px;">   
		   ...
		   <?php 
			...
			<tr style="height:20px">
				...
				<td width="30" align="right" ><?php echo str_money(abs($row['totalQty']),$system['qtyPlaces'])?></td>
				<td width="40" align="center"></td>
				<td width="60" align="center"></td>
				<td width="50" align="center"></td>
			...
			<tr target="id">
				<td colspan="9" style="border:solid #000000;border-width:0 1px 1px 0;padding:2px; font-family:'宋体'; font-size:14px;height:15px;">合计 金额大写： <?php echo str_num2rmb(abs($row['totalAmount']))?> </td> 
			</tr>
			<?php }?>
		</table>
