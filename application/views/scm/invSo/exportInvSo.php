...
<table width="1500px" class="list">
  			<tr><td class='H' align="center" colspan="21"><h3>出库订单记录</h3></td></tr>
  		</table>
		<table width="1500px" class="list"  border="1">
			<thead>
				<tr>
					...
					<th width="120" align="center">接收单位</th>
			...
			<tbody>
				...
				<tr target="id">
					...
					<td rowspan="<?php echo $n?>" ><?php echo $this->common_model->get_invSoStatus($row['billStatus']);?></td>
