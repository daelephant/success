...
var isAdmin = <?php echo $this->common_model->isAdmin(220) ? 'true' : 'false'?>; //是否管理员
  ...
  <div class="bills cf">
    <div class="con-header">
      <dl class="cf">
        ...
        <dd class="pct20 tc">
          <label>单据日期:</label>
          <input type="text" id="date" class="ui-input ui-datepicker-input" value="2015-11-16">
        </dd>
        <dd id="identifier" class="pct20 tc">
          <label>单据编号:</label>
...
<script src="<?php echo base_url()?>statics/js/dist/sales.js?ver=20151110"></script>
</body>
</html>
