...
<div class="wrapper">
  <div class="mod-search cf">
    ...
    <div class="fr">
     ...
     <!-- <div class="ui-btn-menu">
	        <a class="ui-btn menu-btn mrb" style="width: 40px;padding-right: 7px;" href="#" id="export" target="_blank" href="javascript:void(0);">导出</a>
...
<script src="<?php echo base_url()?>statics/js/dist/purchaseList.js?ver=20151110"></script>
</body>
</html>
