...
?>
		<table  width="800"  align="center">
			...
			<tr height="15px">
				<td align="center" style="font-family:'宋体'; font-size:18px; font-weight:normal;height:25px;"><?php echo $row['transType']==150501 ? '采购单' :'采购退货单'?></td>
			</tr>
		</table>	
		...
		<table width="800" align="center">
			<tr height="15" align="left" >
				<td width="250" style="font-family:'宋体'; font-size:14px;height:20px;">供应商：<?php echo $row['contactNo'].' '.$row['contactName']?> </td>
				<td width="10" ></td>
		...
		<table width="800" border="1" cellpadding="2" cellspacing="1" align="center" style="border-collapse:collapse;border:solid #000000;border-width:1px 0 0 1px;">
			<tr style="height:20px">
				...
				<td width="6" style="display:none">折扣率</td>	
				<td width="5" style="border:solid #000000;border-width:0 1px 1px 0;padding:2px; font-family:'宋体'; font-size:14px;height:15px;" align="center">折扣额</td>	
			...
			<tr style="height:20px">
				...
				<td width="220" ><?php echo $row1['invNumber'].' '.$row1['invName'].' '.$row1['invSpec'];?></td>
				<td width="30" align="center"><?php echo $row1['mainUnit']?></td>
				<td width="40" align="right"><?php echo $row1['qty']?></td>
				<td width="60" align="right"><?php echo $row1['price']?></td>
				<td width="6" align="right"><?php echo $row1['discountRate']?></td>
				<td width="5" align="right"><?php echo $row1['deduction']?></td>
				<td width="60" align="right"><?php echo $row1['amount']?></td>
			...
			<tr style="height:20px">
				...
				<td width="30" align="right" ><?php echo str_money($row['totalQty'],$system['qtyPlaces'])?></td>
				<td width="40" align="center"></td>
				<td width="60" align="center"></td>
				<td width="50" align="center"></td>
				<td width="60" align="right" ><?php echo str_money($row['totalAmount'],2)?></td>
				<td width="80" align="center"></td>
			</tr>
 
			<tr target="id">
				<td colspan="9" style="border:solid #000000;border-width:0 1px 1px 0;padding:2px; font-family:'宋体'; font-size:14px;height:15px;">合计 金额大写： <?php echo str_num2rmb($row['totalAmount'])?> </td> 
			</tr>
			<?php }?>
		</table>
		...
		<!-- <table  width="800" align="center">
		    <tr height="25" align="left">
			    <td align="left" width="200" style="font-family:'宋体'; font-size:14px;height:25px;">折扣额：<?php echo str_money($row['disAmount'],2)?></td>
			    <td width="200" style="font-family:'宋体'; font-size:14px;height:25px;">折扣后金额：<?php echo str_money(abs($row['amount']),2)?></td>
				<td width="200" style="font-family:'宋体'; font-size:14px;height:25px;"><?php echo $row['transType']==150501 ? '本次付款：' :'本次退款：'?><?php echo str_money($row['rpAmount'],2)?></td>
				<td width="200" style="font-family:'宋体'; font-size:14px;height:25px;">本次欠款：<?php echo str_money($row['arrears'],2)?></td>
		...
		<table  width="800" align="center">
		    <tr height="25" align="left">
				<td align="left" width="960" style="font-family:'宋体'; font-size:14px;height:25px;">备注： <?php echo $row['description']?></td>
				<td width="0" ></td>
				<td width="0" ></td>
				<td width="0" ></td>
				<td width="0" ></td>
