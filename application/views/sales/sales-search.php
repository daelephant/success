...
<div class="wrapper">
  <div class="mod-search-adv">
    <ul>
      ...
      <li>
        <label>订单状态:</label>
        <input type="checkbox" name="billStatus" value="0" class="vm">未出库
        <input type="checkbox" name="billStatus" value="1" class="vm">部分出库
        <input type="checkbox" name="billStatus" value="2" class="vm">全部出库
        <input type="checkbox" name="billStatus" value="3" class="vm">已关闭
        <!--<input type="checkbox" name="billStatus" value="0" class="vm">未关闭-->
      </li>
      <li>
        <label>收款状态:</label>
        <input type="checkbox" name="hxState" value="0" class="vm"><span>未收款</span>
        <input type="checkbox" name="hxState" value="1" class="vm"><span>部分收款</span>
        <input type="checkbox" name="hxState" value="2" class="vm"><span>全部收款</span>
      </li>
      <li id="check">
        <label>审核状态:</label>
