...
function validMaxForShare(){
    $.ajax({
      url: '../right?action=isMaxShareUser',
      dataType: 'json',
      type: 'POST',
...
<div class="wrapper">
    <div class="mod-toolbar-top">
       <button class="ui-btn ui-btn-sp mrb">新增</button>
       <!-- <a href="javascript:validMaxForShare();" class="ui-btn ui-btn-sp mrb">新增</a> -->
...
<script>
  (function($){
    ...
    $('.grid-wrap').on('click', '.delete', function(e){
      ...
      e.preventDefault();
      $.ajax({
        url: '../right?action=auth2UserCancel&userName=' + userName,
        type: 'POST',
        dataType: 'json',
        success: function(data){
          if (data.status == 200) {
    ...
    $('.grid-wrap').on('click', '.authorize', function(e){
      ...
      e.preventDefault();
       $.ajax({
        type: 'POST',
        dataType: 'json',
        url: '../right?action=auth2User&userName=' + userName,
        success: function(data){
          if (data.status == 200) {
