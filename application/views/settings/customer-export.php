<?php if (!defined('BASEPATH')) exit('No direct script access allowed');?>
		<table class="table" width="1500"  border="1">
			<thead>
				<tr>
				    <th width="120" align="center"><span style="color:#FF0000">接收单位编号</span></th>
					<th width="150" ><span style="color:#FF0000">接收单位名称</span></th>
					<th width="100" align="center">接收单位类别</th>
					<th width="100" align="center">接收单位等级</th>
